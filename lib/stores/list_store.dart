...
class ListProvider with ChangeNotifier {
  ...
  Future<void> addTaskByTitle(
      {required BuildContext context, String? title, int? listId}) {
  ...
  Future<void> addTask(
      {required BuildContext context, Task? newTask, int? listId}) {
    var globalState = VikunjaGlobal.of(context)!;
    _isLoading = true;
    notifyListeners();
  ...
  Future<void> updateTask(
      {required BuildContext context, int? id, bool? done}) async {
    var globalState = VikunjaGlobal.of(context)!;
